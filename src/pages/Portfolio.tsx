  ...
  const projects = [
    {
      ...
      description: "Complete e-commerce solution with advanced filtering, AR try-on features, and seamless checkout experience.",
      technologies: ["React", "Node.js", "Stripe", "AWS"],
      results: ["300% increase in online sales", "50% improvement in conversion rate", "Award-winning UX design"],
      link: "#"
    },
    {
      id: 2,
      ...
      image: "/api/placeholder/800/600",
      description: "Complete brand identity redesign including logo, guidelines, and marketing materials for Series A funding.",
      technologies: ["Adobe Creative Suite", "Figma", "Brand Strategy"],
      results: ["Successful $10M Series A", "200% increase in brand recognition", "Featured in TechCrunch"],
      link: "#"
    },
    {
      id: 3,
      ...
      image: "/api/placeholder/800/600",
      description: "Multi-channel digital marketing strategy resulting in significant user acquisition and retention.",
      technologies: ["Google Ads", "HubSpot", "Analytics", "A/B Testing"],
      results: ["500% ROI on ad spend", "10,000+ new users acquired", "40% increase in customer lifetime value"],
      link: "#"
    },
    {
      id: 4,
      ...
      results: ["1M+ downloads in first year", "99.9% uptime achievement", "Industry security certification"],
      link: "#"
    },
    {
      id: 5,
      ...
      image: "/api/placeholder/800/600",
      description: "Multi-location restaurant website with online reservations, menu management, and loyalty program.",
      technologies: ["Next.js", "Sanity CMS", "Stripe", "Google Maps API"],
      results: ["80% increase in online reservations", "25% growth in loyalty sign-ups", "Mobile-first design award"],
      link: "#"
    },
    {
      id: 6,
      ...
      image: "/api/placeholder/800/600",
      description: "Comprehensive rebrand for healthcare network including logo, patient materials, and digital presence.",
      technologies: ["Brand Strategy", "Illustrator", "InDesign", "Webflow"],
      results: ["Improved patient trust scores", "30% increase in new patient acquisition", "Healthcare design award"],
      link: "#"
    }
  ];
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed mb-10">
                ...
                and achieve remarkable results through strategic design and development.
              </p>
            </div>
          </div>
        </section>
                    ...
                    <div className="p-8">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                          ...
                          project.category === 'branding' ? 'bg-purple-500/10 text-purple-400' :
                          project.category === 'marketing' ? 'bg-green-500/10 text-green-400' :
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {project.technologies.map((tech, idx) => (
                            <span key={idx} className="px-3 py-1 bg-muted/50 text-foreground rounded-full text-sm">
                              {tech}
                            </span>
                          ))}
                        </div>
                      ...
                      {/* Results */}
                      <div className="mb-6">
                        <h4 className="text-sm font-semibold mb-3 text-foreground">Key Results:</h4>
        ...
        <section className="py-20 bg-gradient-to-r from-primary/5 via-secondary/5 to-accent-premium/5">
          <div className="container mx-auto px-6">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div className="group">
                <div className="text-4xl md:text-5xl font-black text-secondary mb-2 font-heading group-hover:scale-110 transition-transform">
                  $50M+
                </div>
