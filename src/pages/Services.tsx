...
import { ArrowRight, Code, Palette, TrendingUp, Cog, Check } from "lucide-react";
...
const Services = () => {
  ...
  const process = [
    ...
    },
    {
      step: "03",
      title: "Design",
      description: "We create stunning visuals and user experiences that align with your brand identity."
    },
    {
      step: "04",
      title: "Development",
      description: "Our developers bring the designs to life with clean, scalable, and optimized code."
    },
    {
      step: "05",
      title: "Launch",
      description: "We ensure a smooth launch with thorough testing and performance optimization."
    },
    {
      step: "06",
      title: "Growth",
      description: "Post-launch support and continuous optimization to maximize your ROI."
    }
  ];
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed mb-10">
                From concept to completion, we provide end-to-end digital solutions 
                ...
                <div key={service.id} className={`grid lg:grid-cols-2 gap-12 items-center ${
                  ...
                  <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                    <div className="glass-card p-8 hover:scale-105 transition-all duration-500">
                      ...
                      <h2 className="text-4xl font-serif font-bold mb-4 mt-2">{service.title}</h2>
              ...
              {process.map((item, index) => (
                <div key={index} className="relative group">
                  <div className="glass-card p-8 h-full hover:scale-105 transition-all duration-300">
                    <div className="text-6xl font-black text-primary/20 mb-4 font-heading">{item.step}</div>
        ...
        <section className="py-20 relative overflow-hidden">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Let's discuss your goals and create a custom solution that 
              drives results and exceeds your expectations.
            </p>
